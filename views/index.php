...
<body>
    ...
    <div id="app" class="container-fluid">
 	...
 	<section class="container">
	    <div class="row pb-0 pe-lg-0 pt-lg-3 align-items-center justify-content-center">
	      <div class="col-lg-6 p-3 p-lg-4 pt-lg-3">
	        <h1 class="display-7 fw-bold lh-1 text-dark">Get Personalized Wedding Invitation Websites</h1>
	        <p class="lead">Start your journey with us, and let's create an invitation that tells your unique love story.</p>
	        <div class="d-grid gap-2 d-md-flex justify-content-md-start mb-4 mb-lg-3">
	          <a href="#" class="btn-theme">Start Now</a>
	        </div>
	      </div>
	      <div class="col-lg-4 offset-lg-1 p-0 shadow-lg overflow-hidden">
	          <img class="rounded-lg-3" src="<?php assets('img/hero.png') ?>" alt="" width="720">
	      </div>
	    </div>
	            ...
	            <div class="tab-content mt-3">
				    ...
				    <div class="tab-pane fade show active" id="section1">
					 <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
				        ...
				        <div class="text-center"> <a href="#" class="btn-theme">Explore</a> </div>
        ...
        <div class="col">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <h3 class="mb-2 text-dark text-center"><span class="fs-6">₹</span> <b> 8000</b></h3>
        ...
        <div class="col">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <h3 class="mb-2 text-dark text-center"><span class="fs-6">₹</span> <b> 16000</b></h3>
        ...
        <div class="col">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <h3 class="mb-2 text-dark text-center"><span class="fs-6">₹</span> <b> 20000+</b></h3>
		...
		<!-- pricing section ends  -->
         ...
         <section class="container testimonials" id="testimonials">
         	<div class="row">
         		...
         		<div class="row feedback-overview"> 
         			<div class="col-sm-5">
         		...
         		<div class="col-sm-6">
         			...
         			<div class="text-center"> <a href="#" class="btn-theme">View Reviews</a> </div>
         ...
         <section class="container contact" id="contact">
         	...
         	<div class="row justify-content-center contact-row">
         		<div class="col-sm-5 contact-col-1">
         			<h3 class="mb-4 text-light">Send us a message</h3>
		         	...
		         	<form>
		                ...
		                <div class="text-center"> <a href="#" class="btn-theme-invert">Send</a> </div>
		            </form>
         		...
         		<div class="col-sm-4 contact-col-2">
                     ...
                     <h3 class="mb-4 text-dark">Contact Us</h3>
