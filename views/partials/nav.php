<nav class="my-2 mx-2 navbar navbar-expand-lg bg-transparent navbar-sticky fixed-top">
    ...
    <li class="nav-item">
        <a class="nav-link" aria-current="page" href="#">Themes</a>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
        <?php if (!App::getSession()) { ?>
            <a class="nav-link btn btn-secondary rounded-pill" aria-current="page" href="<?php echo route('login') . "?back=" . url(); ?>">Login</a>
        <?php } ?>
    </li>
</ul>
