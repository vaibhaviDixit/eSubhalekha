...
// Retrieve bride, groom, and wedding date from GET parameters
$brideName = isset($_GET['bride']) ? htmlspecialchars($_GET['bride']) : 'Bride';
$groomName = isset($_GET['groom']) ? htmlspecialchars($_GET['groom']) : 'Groom';
$weddingDate = isset($_GET['date']) ? htmlspecialchars($_GET['date']) : 'Date';
