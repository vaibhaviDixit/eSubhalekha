...
$backgroundUrl = $_SERVER['DOCUMENT_ROOT']."/test/themes/august_theme/assets/img/bg.jpg"; // URL to a floral background
...
$fontPath = $_SERVER['DOCUMENT_ROOT']."/test/themes/august_theme/"."assets/fonts/Garamond.ttf"; // Regular font for names
$cursiveFontPath = $_SERVER['DOCUMENT_ROOT']."/test/themes/august_theme/"."assets/fonts/Graphene.ttf"; // Cursive font for the "We are getting married" text
