    ...
    <div class="w-full h-full">
      ...
      <div class="w-full relative">
        <div class="absolute -top-[18px] right-[50%] translate-x-[50%] z-40 row w-[180px]">
          <button
            ...
            onclick="window.location.href = '<?php echo $timeline[2]['locationURL'] ?>'">
      ...
      <div class="w-full h-[500px] sm:h-[600px] relative flex justify-center items-start bg-[#DA2E78] overflow-hidden">
        <div class="w-full text-[#FFFFFF] flex flex-col justify-center items-center pt-[150px]">
          <p class="text-[#FFFFFF] text-5xl sm:text-6xl">August 23</p>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form id="rsvpForm" method="POST">
                <div class="modal-body">
                  <div class="mb-3">
                    <label for="attendingInput" class="form-label">Are you attending?</label>
                    <select class="form-select" id="attendingInput" name="attending" required>
                  ...
                  <div class="mb-3">
                    <label for="namesInput" class="form-label">Names of people attending*</label>
                    <textarea class="form-control" id="namesInput" name="names" rows="3" required></textarea>
                  </div>
                  <div class="mb-3">
                  ...
                  <div class="modal-footer">
                    <button id="submitBtn" type="button"
                      class="h-[36px] w-[150px] rounded-l-full rounded-r-full border-[3px] text-[#FFF] border-[#DA2E78] bg-[#DA2E78] active:scale-90 duration-300 ease-in-out focus:outline-none active:outline-none">Submit</button>
                  </div>
                </div>
              </form>
              <script>
                document.getElementById("submitBtn").addEventListener("click", function () {
                  var attending = document.getElementById("attendingInput").value;
                  ...
                  var url = "https://api.whatsapp.com/send?phone=+919989352171&text=" +
                    encodeURIComponent('Attending: ' + attending + '\nPhone: ' + phone +
                      '\nNames: ' + names + '\nMessage: ' + message);
            ...
            <div class="path-div" data-index="1" data-percentage="40">
              ...
              <div
                ...
                <p class="w-full px-1 text-sm text-center font-light">
                  since the 1500s, when an unknown printer took a galley of
                  type and scrambled it to make a type specimen book. It has
                  survived not only five centuries, but also the since the
