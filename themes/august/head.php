<head>
    ...
    <meta name="description" content="Join us in celebrating the wedding of <?php echo $weddingData['brideName'];?> and <?php echo $weddingData['groomName'];?> on August 23, 2024. Get all the details, RSVP, and share your best wishes online.">
    ...
    <meta property="og:description" content="Join us in celebrating the wedding of <?php echo $weddingData['brideName'];?> and <?php echo $weddingData['groomName'];?> on August 23, 2024. Get all the details, RSVP, and share your best wishes online." />
    ...
    <meta name="twitter:description" content="Join us in celebrating the wedding of <?php echo $weddingData['brideName'];?> and <?php echo $weddingData['groomName'];?> on August 23, 2024. Get all the details, RSVP, and share your best wishes online." />
    ...
    <!-- Theme CSS -->
    <link rel="stylesheet" href="<?php themeAssets('august',"index.css"); ?>" />
